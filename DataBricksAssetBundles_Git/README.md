# DataBricksAssetBundles_Git

The 'DataBricksAssetBundles_Git' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/DataBricksAssetBundles_Git/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] DataBricksAssetBundles_Git_etl` to your workspace.
